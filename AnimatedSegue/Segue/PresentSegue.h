...
@protocol TransitionNotification
...
@protocol PresentSegueDelegate <NSObject>
...
/**
 @abstract An object conforming to the PresentSegueDelegate method.
 @discussion Must be set before this segue receive the 'perform' method call
 */
@property (nonatomic, weak) id <PresentSegueDelegate> delegate;
